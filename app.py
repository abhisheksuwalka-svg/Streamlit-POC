...
# HEADER
# =============================================================
st.markdown('<p class="dashboard-title">ARR Dashboard</p>', unsafe_allow_html=True)
st.markdown('<p class="dashboard-subtitle">Annual Recurring Revenue | Live from Snowflake | ARR_WAREHOUSE.ARR_ANALYTICS</p>', unsafe_allow_html=True)
